...
/**
 * Created by chenhaitao on 2018/7/31.
 */
public class HttpClientUtil {
    ...
    static {
        ...
        // 在提交请求之前 测试连接是否可用,4.4版本后默认是true
...
//            httpclient=HttpClients.createDefault();
            httpclient = getHttpClientByPool();
        }
        try {
            HttpGet httpGet = new HttpGet(apiUrl);
            response = httpclient.execute(httpGet);
            int statusCode = response.getStatusLine().getStatusCode();
            System.out.println("get请求返回码："+statusCode);
...
//        CloseableHttpClient httpClient = HttpClients.createDefault();
     ...
     * @return
     */
    public static CloseableHttpClient getHttpClientByPool(){
    ...
    public static void main(String[] args) {
        ...
        jsonObject.put("info","百家姓前十个");
        System.out.println("*************"+jsonObject.toString());
        String result = null;
        try {
            result = doPost("http://www.tuling123.com/openapi/api",jsonObject);
        } catch (Exception e) {
            e.printStackTrace();
        }
